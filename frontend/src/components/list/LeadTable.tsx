                  ...
                  <Menu.Item>
                    {({ active }) => (
                      <button
                        onClick={onAddLead}
                        className={`
                          flex w-full items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50
                          ${active ? 'bg-gray-50' : ''}
                        `}
                      >
                  ...
                  <Menu.Item>
                    {({ active }) => (
                      <button
                        ...
                        `}
                      >
                        <svg className="h-4 w-4 mr-3 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
